...
import { Shirt, StarIcon, MessageSquareIcon } from 'lucide-react';
...
const HomePage = () => {
  ...
  return (
    <motion.div
      className="bg-gradient-to-br from-gray-900 to-black min-h-screen text-white font-sans"
      initial="initial"
      animate="animate"
    ...
    >
      ...
      <section className="py-12 md:py-16 lg:py-20">
        ...
        >
          ...
          <Link to="/shop" className="bg-white/5 backdrop-blur-md p-6 rounded-lg shadow-md hover:scale-105 transition-all duration-300 cursor-pointer">
